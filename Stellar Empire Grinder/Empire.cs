...
namespace Stellar_Empire_Grinder
{
    internal class Empire
    {
        ...
        internal Empire(string name, string adjective, int economy, int fleet, int colonizedPlanets, int habitablePlanets, int economyDecilesRemaining, int generalWelfareDeciles, int explorationDeciles, 
        ...
        internal void Turn()
        {
            ...
            Console.WriteLine("Your astronomers are aware of " + HabitablePlanets + " worlds.");
